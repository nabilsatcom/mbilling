...
class Rate extends Model
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id_plan, id_prefix, id_trunk_history, History_Number, id_trunk_group,WL1,2min,att2min,5min,att5min,15min,att15min,1h,att1h,4h,att4h,1d,att1d, initblock, billingblock, package_offer, minimal_time_charge ', 'numerical', 'integerOnly' => true),
    ...
    {
        if (count($rates) > 0) {
            $sql = 'INSERT INTO pkg_rate (id_prefix, id_plan, rateinitial,  id_trunk_history, History_Number, id_trunk_group, WL1,FRCalled, FRCaller, FNCalled, FNCaller,2min,att2min,5min,att5min,15min,att15min,1h,att1h,4h,att4h,1d,att1d, initblock, billingblock,  status) VALUES ' . implode(',', $rates) . ';';
    ...
    public function insertRates($userType, $sqlRate)
    {
        ...
        if ($userType == 1) {
            $sqlRate = 'INSERT INTO pkg_rate (id_prefix, id_plan, rateinitial, id_trunk_history, History_Number, id_trunk_group,WL1,FRCalled,FRCaller,FNCalled,FNCaller,2min,att2min,5min,att5min,15min,att15min,1h,att1h,4h,att4h,1d,att1d, initblock, billingblock, status) VALUES ' . implode(',', $sqlRate) . ';';
        } else {
