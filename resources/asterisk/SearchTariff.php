...
class SearchTariff
{
    ...
    public function find(&$MAGNUS, &$agi)
    {
        ...
        "pkg_rate.additional_grace AS additional_grace, package_offer, FRCalled, FRCaller, FNCalled, FNCaller, id_trunk_history, History_Number, WL1, WL2, WL3, 2min, att2min, 5min, att5min, 15min, att15min, 1h, att1h, 4h, att4h, 1d, att1d ,id_trunk_group1, id_trunk_group2, id_trunk_group3, pkg_trunk_group.type AS trunk_group_type " .
        "FROM pkg_plan " .
