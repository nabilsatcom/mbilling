...
class CalcAgi
{
    ...
    // *********************************************************************************************************
        ...
        if ($this->WL1 == 1 || $this->WL1 == 0) {

            if ($this->WL1 == 1) {
        
            $sql = "SELECT id FROM pkg_restrict_phone WHERE  id_user = $MAGNUS->id_user AND (number = SUBSTRING('" . $MAGNUS->destination . "',1,length(number))  OR number = SUBSTRING('" . $MAGNUS->CallerID . "',1,length(number))  ) ORDER BY LENGTH(number) DESC";
            } else {
            ...
            $modelRestrictedWL1 = $agi->query($sql)->fetch(PDO::FETCH_OBJ);
            ...
            if ($this->tariffObj[0]['WL1'] == 0) {
                ...
                /* NOT ALLOW TO CALL RESTRICTED NUMBERS*/
                if (!isset($modelRestrictedWL1->id)) {
    ...
    // *********************************************************************************************************
        ...
        if ($this->WL2 == 1 || $this->WL2 == 0) {
            ...
            $modelRestrictedWL2 = $agi->query($sql)->fetch(PDO::FETCH_OBJ);

            $agi->verbose("RESTRICTED NUMBERS ", 15);

            if ($this->tariffObj[0]['WL2'] == 0) {

                /* NOT ALLOW TO CALL RESTRICTED NUMBERS*/
                if (!isset($modelRestrictedWL2->id)) {
            ...
            } else if ($this->tariffObj[0]['WL2'] == 1) {
    ...
    // *********************************************************************************************************
        ...
        if ($this->WL3 == 1 || $this->WL3 == 0) {
            ...
            $modelRestrictedWL3 = $agi->query($sql)->fetch(PDO::FETCH_OBJ);
        
            $agi->verbose("RESTRICTED NUMBERS ", 15);
        
            if ($this->tariffObj[0]['WL3'] == 0) {
            
                /* NOT ALLOW TO CALL RESTRICTED NUMBERS*/
                if (!isset($modelRestrictedWL3->id)) {
            ...
            } else if ($this->tariffObj[0]['WL3'] == 1) {
